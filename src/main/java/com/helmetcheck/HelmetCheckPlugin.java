...
public class HelmetCheckPlugin extends Plugin
{
	...
	{
		log.info("Helmet check has started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Helmet check has stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Helmet-Check Plugin says: " + config.greeting(), null);
		}
	}
